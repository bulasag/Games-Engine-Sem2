...
namespace BGE
{
    public class FPSController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                Walk(Time.smoothDeltaTime * speed);
            }
            ...
            {
                Strafe(- Time.smoothDeltaTime * speed);
            }
            ...
            {
                Roll(- Time.smoothDeltaTime * speed);
            }
            ...
            Walk(-contWalk * speed * Time.smoothDeltaTime);
            Strafe(contStrafe * speed * Time.smoothDeltaTime);
