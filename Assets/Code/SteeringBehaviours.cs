...
#region Utilities        
        private void makeFeelers()
        {
			...
			// Use the up vector as an axis, 45 degree rotation to the right
			...
			// Left Feeler
            newFeeler = Vector3.forward * feelerDistance;
			// Use the up vector as an axis, 45 degree rotation to the left
            newFeeler = Quaternion.AngleAxis(-45, Vector3.up) * newFeeler;
            newFeeler = transform.TransformPoint(newFeeler);
            Feelers.Add(newFeeler);

			// Low Feeler
            newFeeler = Vector3.forward * 2.0f;
			// Use the right vector as an axis, 45 degree rotation upwards
...
#region Integration
        ...
        void Update()
        {
            ...
            timeDelta = Time.smoothDeltaTime * Params.timeModifier;
        ...
        Vector3 ObstacleAvoidance()
        {
            ...
            if (closestIntersectingObstacle != null)
            {
				...
				force.y = 0;
				//No y value in the obstacle avoidance is calculated to give the feeling of anti-grav 2-D movement
