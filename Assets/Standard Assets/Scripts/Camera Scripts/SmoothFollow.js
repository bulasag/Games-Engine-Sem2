...
function LateUpdate ()
{
	...
	// Early out if we don't have a targetship
	if (!targetship)
		return;
	
	// Calculate the current rotation angles
	var wantedRotationAngle = targetship.transform.eulerAngles.y;
	var wantedHeight = targetship.transform.position.y + height;
	...
	// distance meters behind the targetship
